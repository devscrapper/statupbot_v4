...
module Pages
  ...
  class EngineSearch < Page
    ...
    # attribut
    #----------------------------------------------------------------------------------------------------------------
    attr_reader :input, # zone de saisie des mot cl�s
    ...
    def initialize(visit, browser)
      ...
      begin
        ...
        #teste la pr�sence de la zone de saisie
        #parfois la page n'est pas affich�e mais l'url ipv4.google... est bien dans la zone de l'url
